                        ...
                        <tr class=" bg-white dark:bg-gray-800  hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="py-4 ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <button data-modal-target="edit-modal{{$row['id']}}" data-modal-toggle="edit-modal{{$row['id']}}"
                        ...
                        <div tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative w-full max-w-md max-h-full zoom-in">
                                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form class="p-4 md:p-5" action="/superadmin/admindesa" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-5">
                                            <label for="id_akun"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> {{ $row['desa']['nama'] }}
                                            </label>
                                            <select id="id_akun" name="id_akun"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option hidden>Piih Akun</option>
