                        ...
                        <div class="relative w-full max-w-md max-h-full zoom-in">
                            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form class="p-4 md:p-5" action="/superadmin/admindesa" method="POST" enctype="multipart/form-data">
                                    ...
                                    <!-- Akun Selection -->
                                    <div class="mb-5">
                                        <label for="id_akun" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            {{ $row['desa']['nama'] }}
                                        </label>
                                        <select id="id_akun" name="id_akun"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            @if (isset($row['id_akun']))
                                                <option hidden value="{{ $row['id_akun'] }}">{{ $row['akun']['nama'] }}</option>
                                            @else
                                                <option hidden value="">Pilih Akun</option>
                                            @endif
                                            @foreach ($akun as $akunItem)
                                                <option value="{{ $akunItem['id'] }}">{{ $akunItem['nama'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        <label for="id_desawisata" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Pilih Desa Wisata
                                        </label>
                                        <select id="id_desawisata" name="id_desawisata"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            @if (isset($row['id_desawisata']))
                                                <option hidden value="{{ $row['id_desawisata'] }}">{{ $row['desa']['nama'] }}</option>
                                            @else
                                                <option hidden value="">Pilih Desa Wisata</option>
                                            @endif
                                            @foreach ($desawisata as $desaItem)
                                                <option value="{{ $desaItem['id'] }}">{{ $desaItem['nama'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
