...
@section('main')
    ...
    <div class="mx-4">
        ...
        <<<<<<< HEAD <div class="relative overflow-x-auto mt-5 border-gray-200 rounded-lg shadow">
            <table id="example" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <div class="relative overflow-x-auto mt-5 border-gray-200 rounded-lg shadow p-3">
                    <table id="myTable"
                        ...
                        >>>>>>> 1ee1ce8d367503643588d3292669983df18d7dca
    ...
    <script>
        ...
        >>> > 1 ee1ce8d367503643588d3292669983df18d7dca
    </script>
@endsection
