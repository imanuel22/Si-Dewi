...
<div class="container h-screen w-full">
    <nav class="bg-white poppins-bold border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class=" hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="poppins-bold flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="#"
...
<div>
    <div class="relative h-96">
        ...
        <img src="{{ asset('storage/img/background.jpg') }}" class="absolute inset-0 w-full h-full object-cover" alt="">

        <!-- Konten Teks di Atas Gambar -->
        <div class="relative z-10 flex flex-col justify-center items-center h-full text-white text-4xl poppins-bold tracking-normal">
            <div>
                <h1>EXPLORE BALI</h1>
            </div>
            <div>
