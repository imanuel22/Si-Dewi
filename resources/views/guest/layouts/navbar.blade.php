    ...
    <div class="max-w-screen flex flex-wrap items-center justify-between mx-auto ">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                <li>
                    <a href="{{url('/')}}" class="block py-2 px-3 rounded md:bg-transparent" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="{{url('/jelajahi')}}" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent">Desa Wisata</a>
                </li>
                <li>
                    <a href="{{url('/artikel')}}" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent">Artikel</a>
                </li>
            </ul>
        </div>
    </div>
