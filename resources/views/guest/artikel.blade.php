    ...
    <div class="container-fluid">
        ...
        <nav class="sticky top-0 border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 x2l:px-44 md:px-20 sm:px-20">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                ...
                <li class="lg:mx-7">
                    <a href="#" class="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 
                    md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
                </li>
                <li class="lg:px-7">
                    <a href="#" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
