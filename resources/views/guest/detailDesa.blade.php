...
<body>
    ...
    <div class="container-fluid h-screen">
        ...
        <img src="{{ env('APP_API_URL') }}/resource/desawisata/{{ $desa['gambar'] }}" alt=""
            class=" inset-0 w-full sm:h-full object-cover" style="width: 100vw;">
            ...
            <div
                ...
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="destinasi-styled-tab"
                            data-tabs-target="#styled-destinasi" type="button" role="tab" aria-controls="destinasi"
                            aria-selected="false">Destinasi</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="akomodasi-styled-tab" data-tabs-target="#styled-akomodasi" type="button" role="tab"
                            aria-controls="akomodasi" aria-selected="false">Akomodasi</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="produk-styled-tab" data-tabs-target="#styled-produk" type="button" role="tab"
                            aria-controls="produk" aria-selected="false">Produk</button>
                    </li>
                    <li role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="pawi-styled-tab" data-tabs-target="#styled-pawi" type="button" role="tab"
                            aria-controls="pawi" aria-selected="false">Paket Wisata</button>
                    </li>
                </ul>
            </div>
            <div>
                <div id="default-styled-tab-content"
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 " id="styled-destinasi"
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-produk" role="tabpanel"
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-pawi" role="tabpanel"
                    ...
                    @foreach ($produk as $row)
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <a href="/desa/{{ $row['id_desawisata'] }}/produk/{{ $row['id'] }}">
                                    <h5 class="mb-2 text-sm font-bold tracking-tight text-green-700 dark:text-white">
                                        {{ $row['harga'] }}</h5>
                                </a>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                    {{ Str::limit($row['deskripsi'], 100, '...') }}</p>
