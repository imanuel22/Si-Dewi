<div class="bg-white mt-6 sm:mt-0 rounded-2xl p-6 mb-6">
    ...
    <div class="">
        <div class="flex items-center mb-3 gap-3">
            ...
            <p class="text-xl">{{ $informasi['no_telp'] }}</p>
        </div>
    </div>
    ...
    <div class="">
        <div class="flex items-center mb-3 gap-3">
            ...
            <p class="text-xl">{{ $informasi['email'] }}</p>
        </div>
    </div>


    <!-- Website -->
    <a href="{{ $informasi['website'] }}">
        <div class="flex items-center mb-3 gap-3">
            <svg class="w-8 h-8 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-xl">{{ $informasi['website'] }}</p>
        </div>
    </a>
    <hr class="my-3">
    ...
    <a href="https://wa.me/{{ $informasi['no_wa'] }}" class="">
        <div class="flex items-center mb-3 gap-3">
            ...
            <p class="text-xl">{{ $informasi['no_wa'] }}</p>
        </div>
    </a>
    ...
    <div class="">
        <div class="flex items-center mb-3 gap-3">
            ...
            <p class="text-xl">{{ $informasi['facebook'] }}</p>
        </div>
    </div>
    ...
    <div class="">
        <div class="flex items-center mb-3 gap-3">
            ...
            <p class="text-xl">{{ $informasi['instagram'] }}</p>
        </div>
    </div>
