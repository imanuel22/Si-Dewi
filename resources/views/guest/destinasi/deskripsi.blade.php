<div class="mb-2 bg-white rounded-2xl sm:w-3/5 sm:p-8 p-6 h-fit ">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="xl:text-5xl md:text-4xl text-4xl font-bold max-w-2xl text-left">
                {{ $destinasi['nama'] }}
            </h1>
            <p class="font-semibold mt-2">
                {{ $desa['nama'] }} / {{ $destinasi['id_kategoridestinasi'] }}
            </p>
        </div>
        <div class="star flex flex-col items-center">
            ...
            <h1 class="text-center text-sm lg:text-xl mt-1 font-semibold">4.5/5 (100)</h1>
        </div>
    </div>
    <div class="deskripsi">
