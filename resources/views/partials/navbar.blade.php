    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
     ...
     text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400
      dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div class="w-full  md:block md:w-auto bg-blend-difference mix-blend-difference text-slate-950 "
            id="navbar-solid-bg">
            <ul
                class="flex flex-col font-medium mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0
         md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700 ">
                <li class="lg:mx-7 ">
                    <a href="{{ url('/') }}"
                        class="block text- py-2 px-3 md:p-0 text-white  bg-blue-700 rounded md:bg-transparent md:dark:bg-transparent hover:bg-gray-100 md:hover:bg-transparent md:border-0
            md:hover:text-blue-700  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-gray-900
            md:dark:hover:bg-transparent mix-blend-lighten"
                        aria-current="page">Home</a>
                </li>
                <li class="lg:px-7">
                    <a href="{{ url('/artikel') }}"
                        class="block py-2 px-3 md:p-0 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
             md:hover:text-blue-700  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-gray-900
             md:dark:hover:bg-transparent">Artikel</a>
                </li>
                <li class="lg:pl-7">
                    <a href="{{ url('/event') }}"
                        class="block py-2 px-3 md:p-0 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
