<nav class="fixed top-0 bg-transparent backdrop-blur-md shadow-md x2l:px-44 md:px-20 sm:px-20 w-screen">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="{{ asset('storage/img/logoM.png') }}" class="h-8" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap">Si Dewi</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
        ...
        <li class="lg:mx-7">
            <a href="{{url('/')}}" class="block py-2 px-3 md:p-0 text-gray-900 bg-blue-700 rounded md:bg-transparent md:text-blue-700 
        ...
        <li class="lg:px-7">
            <a href="{{url('/artikel')}}" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
             md:hover:text-blue-700 dark:text-gray-900 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-gray-900 
