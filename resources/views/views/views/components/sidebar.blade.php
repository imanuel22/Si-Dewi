...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/"
                    class="{{ request()->is('/') ? 'text-white rounded-lg dark:text-white bg-gray-900 hover:bg-gray-600' : 'text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2  group">
            ...
            <li>
                <a href="/Admin/ProfilDesa"
                    class="{{ request()->is('Admin/ProfilDesa') ? 'text-white rounded-lg dark:text-white bg-gray-900 hover:bg-gray-600' : 'text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2  group">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
                <a href="/Admin/paket-wisata"
                    class="{{ request()->is('admin/paket-wisata') ? 'text-white rounded-lg dark:text-white bg-gray-900 hover:bg-gray-600' : 'text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2  group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path
