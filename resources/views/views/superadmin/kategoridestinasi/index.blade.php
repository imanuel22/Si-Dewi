                ...
                <tr class="bg-white  dark:bg-gray-800">
                    ...
                    <td class="py-4 ">
                        <div class="flex justify-center items-center">
                            ...
                            <a data-modal-target="edit-modal{{ $row['id'] }}" data-modal-toggle="edit-modal{{ $row['id'] }}"
                            ...
                            <form action="/superadmin/kategoridestinasi/{{ $row['id'] }}" method="post" class="delete-form">
                                @csrf
                                @method('DELETE')
                                <button type="button"
                                    class="mt-3 delete-button focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"><svg
                                        class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="relative w-full max-w-md max-h-full p-4">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5">
                                <form class="p-4 md:p-5 -mt-1" action="/superadmin/kategoridestinasi/{{ $row['id'] }}"
                                    method="POST">
                                    @csrf
                                    @method('PATCH')
    ...
    (function(factory) {
        ...
        $.extend(true, DataTable.ext.classes, {
            ...
            thead: {
                ...
                cell: 'border px-3 py-4 text-center'
            },
            tbody: {
