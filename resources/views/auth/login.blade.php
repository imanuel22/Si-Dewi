...
@section('main')
    ...
    <h1 class="text-3xl mb-5 font-medium">Welcome Back</h1>
    <div class="w-full max-w-lg p-4 bg-white  rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <p class="text-2xl tracking-tight font-light  text-gray-900 dark:text-white ">Sign in to SiDewi </p>
    ...
    <button type="submit"
        class="text-white w-full text-base max-w-xs mt-10 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  px-3 py-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
